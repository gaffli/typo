...
public:
    ...
    void setupUi(QDialog *info)
    {
        ...
        label_2->setGeometry(QRect(115, 100, 211, 81));
        b_back = new QPushButton(frame);
        b_back->setObjectName(QStringLiteral("b_back"));
        b_back->setGeometry(QRect(105, 250, 111, 51));
        pushButton = new QPushButton(frame);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(105, 170, 111, 51));
    ...
    void retranslateUi(QDialog *info)
    {
        ...
        label_2->setText(QApplication::translate("info", "Version 1.0.1", Q_NULLPTR));
