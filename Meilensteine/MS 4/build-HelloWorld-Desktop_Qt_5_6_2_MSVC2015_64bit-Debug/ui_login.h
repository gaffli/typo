...
public:
    ...
    void retranslateUi(QDialog *login)
    {
        ...
        lab_benutzer->setText(QApplication::translate("login", "Benutzername", 0));
        lab_passwort->setText(QApplication::translate("login", "Passwort", 0));
        lab_status->setText(QApplication::translate("login", "Status", 0));
        but_anmelden->setText(QApplication::translate("login", "Anmelden", 0));
        label->setText(QApplication::translate("login", "Noch nicht registriert?", 0));
        label_10->setText(QApplication::translate("login", "Benutzername", 0));
        label_11->setText(QApplication::translate("login", "Passwort", 0));
        reg_status->setText(QApplication::translate("login", "Status", 0));
        label_12->setText(QApplication::translate("login", "E-Mail Adresse", 0));
        abbrechen_anmelden->setText(QApplication::translate("login", "Zur\303\274ck zum Hauptmen\303\274", 0));
        button_registrieren->setText(QApplication::translate("login", "Registrieren", 0));
        pb_abmelden->setText(QApplication::translate("login", "Abmelden", 0));
        pb_zurueck->setText(QApplication::translate("login", "Zur\303\274ck zum Hauptmen\303\274", 0));
        label_2->setText(QApplication::translate("login", "Profil von", 0));
        label_username->setText(QString());
        label_3->setText(QApplication::translate("login", "WPM", 0));
        label_wpm->setText(QApplication::translate("login", "0", 0));
        label_4->setText(QApplication::translate("login", "FPM", 0));
        label_fpm->setText(QApplication::translate("login", "0", 0));
        label_5->setText(QApplication::translate("login", "Anzahl der \303\234bungen ", 0));
        label_6->setText(QApplication::translate("login", "bei Modi \303\234ben:", 0));
        label_modiueben->setText(QApplication::translate("login", "0", 0));
        label_7->setText(QApplication::translate("login", "bei Modi Lernen:", 0));
        label_8->setText(QApplication::translate("login", "bei Modi Zeitrennen:", 0));
        label_9->setText(QApplication::translate("login", "bei Modi Wettkampf:", 0));
        label_mdilernen->setText(QApplication::translate("login", "0", 0));
        label_modiwett->setText(QApplication::translate("login", "0", 0));
        label_modizeit->setText(QApplication::translate("login", "0", 0));
    } // retranslateUi
