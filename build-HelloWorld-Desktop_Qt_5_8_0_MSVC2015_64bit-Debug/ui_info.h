...
public:
    ...
    void retranslateUi(QDialog *info)
    {
        ...
        label_4->setText(QApplication::translate("info", "In Typo lernst du das 10-Finger-Tipp System, um keine Typo (Tippfehler) mehr zu schreiben. Zus\303\244tzlich wirst ", Q_NULLPTR));
        ...
        label_7->setText(QApplication::translate("info", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Lernen: </span>Anf\303\244nger? Dann lerne dort f\303\274r jeden Finger die richtige Zuordnung, der Tasten! Beachte dabei, dass f\303\274r </p></body></html>", Q_NULLPTR));
